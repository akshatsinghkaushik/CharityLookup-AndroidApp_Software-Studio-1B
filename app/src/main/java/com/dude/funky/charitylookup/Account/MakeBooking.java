...
public class MakeBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectItemTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MakeBooking.this,
                        R.style.Theme_AppCompat_DayNight_Dialog_Alert);
                builder.setTitle("Name or description of item");

                // Set up AlertDialog input textbox
                final EditText input = new EditText(MakeBooking.this);
                    ...
                    db.collection("Bookings").document(user.getEmail())
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(MakeBooking.this, "Booking Failed", Toast.LENGTH_SHORT).show();
                                }
                            });
